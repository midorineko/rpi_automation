...
class C:
    def score_method(self, sea_score, sea_score_last, suck_score, suck_score_last):
        ...
        b.lights(3, 'state', bri=255, on=True, xy=[0.1618, 0.3365])
        b.lights(4, 'state', bri=255, on=True, xy=[0.1638, 0.3531])
        b.lights(1, 'state', bri=255, on=False, xy=[0.1638, 0.3531])
        b.lights(2, 'state', bri=255, on=False, xy=[0.2263, 0.3402])
        b.lights(3, 'state', bri=255, on=False, xy=[0.1618, 0.3365])
        b.lights(4, 'state', bri=255, on=False, xy=[0.1638, 0.3531])
...
while game_on:
    ...
    if winning_team == 'SEA':
        ...
        b.lights(1, 'state', bri=254, on=False, xy=[0.1637, 0.3522])
        b.lights(2, 'state', bri=254, on=False, xy=[0.169, 0.1308])
        b.lights(3, 'state', bri=254, on=False, xy=[0.1497, 0.1939])
        b.lights(4, 'state', bri=254, on=False, xy=[0.2344, 0.5274])
        b.lights(1, 'state', bri=254, on=True, xy=[0.1637, 0.3522])
        b.lights(2, 'state', bri=254, on=True, xy=[0.169, 0.1308])
        b.lights(3, 'state', bri=254, on=True, xy=[0.1497, 0.1939])
        b.lights(4, 'state', bri=254, on=True, xy=[0.2344, 0.5274])
        ...
        b.lights(1, 'state', bri=255, on=False, xy=[0.6065, 0.3095])
        b.lights(2, 'state', bri=255, on=False, xy=[0.6883, 0.306])
        b.lights(3, 'state', bri=255, on=False, xy=[0.6883, 0.306])
        b.lights(4, 'state', bri=255, on=False, xy=[0.6065, 0.3095])
        b.lights(1, 'state', bri=255, on=True, xy=[0.6065, 0.3095])
        b.lights(2, 'state', bri=255, on=True, xy=[0.6883, 0.306])
        b.lights(3, 'state', bri=255, on=True, xy=[0.6883, 0.306])
        b.lights(4, 'state', bri=255, on=True, xy=[0.6065, 0.3095])
